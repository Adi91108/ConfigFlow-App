      ...
      <div className="flex-1 overflow-y-auto no-scrollbar  px-4">
        <ul>
          <li className="py-1  cursor-pointer">
            ...
            <div className="mt-5">
              <span className="flex items-center font-small text-[16px]  py-2 textwhite">
                <MdInfo className="text-[#FF7A00] mr-2" /> Last 2 commits
                scanned
              </span>
              <span className="flex items-center font-small text-[16px]  text-white">
          ...
          <li className="py-1 my-3  cursor-pointer">
            <label className="block font-small text-[16px] mb-3">
              Selected flow
            </label>
            <select className="w-full bg-[#363636] border-[#D9D9D9] border-2 rounded-lg mt-1 p-2 appearance-none custom-arrow ">
              <option className="font-small text-[16px] text-white">
                POST /carts/{"{cart_id}"}
              </option>
            </select>
          </li>
          <li className="py-2  cursor-pointer">
            <label className="block font-small text-base">Dependencies</label>
            ...
            <div className="mt-2.5 pr-1">
                ...
                {dependency?.map((item) => (
                  ...
                  >
                    <div className="flex justify-center items-center">
                      ...
                      <label
                        htmlFor={item}
                        className="ms-2 text-[15px] font-small text-white"
                      >
                        {item}
                      </label>
                    </div>
              ...
              {/* We Can Add more checkboxes as needed or customer choice */}
            </div>
          </li>
          <li className="pt-3 pb-2  cursor-pointer">
            <label className="block  font-small text-base">Databases</label>
            <span className="text-sm text-[#B7B7B7]">
          ...
          <li className="  cursor-pointer">
            <label className="block font-small">Database Configurations</label>
            <div className="mt-7">
